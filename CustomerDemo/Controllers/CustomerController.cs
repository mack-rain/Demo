...
namespace CustomerDemo.Controllers
{
    ...
    public class CustomerController : Controller
    {
        ...
        [HttpGet("leaderboard")]
        public IActionResult LeaderBoard([FromQuery] int start, [FromQuery] int end)
        {
        ...
        public IActionResult GetCustomersByID(long customerId, [FromQuery] int high, [FromQuery] int low)
        {
            List<CustomerModel> result = new List<CustomerModel>();
            bool isFind = false;
            int index = 1;
        ...
        public IActionResult SetCustomer(long customerId, decimal score)
        {
            if (customerId > 0)
            {
                CustomerModel temp;
